...
#ifndef LIVE2D_CUBISM_RENDERING_H
#define LIVE2D_CUBISM_RENDERING_H
...
/// Enumeration of OpenGL context types.
typedef enum csmGlVersion
{
	csmStub,

	/// Value identifying an OpenGL 3.3 Core profile.
	csmGl33,

	/// Value identifying an OpenGLES 2.0 profile.
	csmGles20
}
csmGlVersion;
...
/// Gets the OpenGL version required.
///
